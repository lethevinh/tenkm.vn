...
trait Taggable
{
    ...
    public static function getTagClassName(): string
    {
        ...
        $class = Tag::class;
        $modelTagClass = "App\\Models\\".$modelKey."Tag";
    ...
    {
        return $this
            ->morphToMany(self::getTagClassName(), 'taggable', 'taggable','taggable_id', 'tag_id')
            ->ordered();
    }
    ...
    public function syncTags($tags)
    {
        ...
        $tags = collect($this->tags()->firstOrCreate($tags));
