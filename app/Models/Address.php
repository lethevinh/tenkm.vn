...
class Address extends Model
{
    ...
    protected $fillable = [
        "provincial_id", "district_id", "ward_id", "street_id", "show_in_parrent", "show_form_search", "postal_code_nb", "address_lb", "type_lb", "status_lb",
        "location_lb", "lat_lb", "lng_lb", 'apartment_number'
    ];
