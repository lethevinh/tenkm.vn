            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    ...
                    <div class="teacher__skills">
                        @foreach($user->skills as $skill)
                            <h5>{{$skill->title_lb}}<span><a>Sửa</a></span></h5>
                        @endforeach
                    </div> <!-- .teacher__skills -->
                </div>
                <div class="col-sm-6 col-md-8">
                    ...
                    <div class="teacher__branch" >
                        Châm ngôn:
                        <span  @if($user->id == Auth::user()->id) class="editable_field" data-field-name="maxim" data-field-label="Description" data-field-type="textarea"  @endif>
                            {{$user->maxim}}
                        </span>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($user->courses as $course)
                            <tr>
                                <td>
                                    <div class=""><a href="{{$course->link}}">{{$course->title_lb}}</a></div>
                                </td>
                                <td>
                                    <div class="">{{__('site.'.$course->pivot->status_sl)}}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="">
                                        @if($course->pivot->status_sl == 'passed')
                                            <a href="{{$course->certificatelink}}" download >{{__('site.download_certificate')}}</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
