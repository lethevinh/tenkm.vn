            ...
            <div class="col-sm-6 col-md-4">
                ...
                <ul class="teacher__contact">
                    <li><i class="ion-ios-home" aria-hidden="true"></i>
                        <span  @if($edit) class="editable_field" data-field-name="company" data-field-label="company" @endif>
                        {{ $user->company }}
                        </span>
                    </li>
                    <li><i class="ion-ios-location" aria-hidden="true"></i>
                        <span @if($edit) class="editable_field" data-field-name="address" data-field-label="address" @endif>
                        {{ $user->address }}
                        </span>
                    </li>
