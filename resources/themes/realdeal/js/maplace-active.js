    ...
    var LocsA = [
        {
            ...
            html: [ '<div class="single-feature">',
                        '<thumb><img src="images/feature/4.png" alt="img"></thumb>',
                        '<div class="details">',
                            '<a href="#" class="feature-logo"><img src="images/icons/l3.png" alt="icons"></a>',
        ...
        },
        {
            ...
            title: 'Property 2',
            html: [ '<div class="single-feature">',
                        '<thumb><img src="images/feature/5.png" alt="img"></thumb>',
                        '<div class="details">',
                            '<a href="#" class="feature-logo"><img src="images/icons/l3.png" alt="icons"></a>',
                            '<p class="author"><i class="fa fa-user"></i> Vilma Jarvi By Redbrox</p>',
                            '<h6 class="title"><a href="properties-details.html">Jason Landville Apartment</a></h6>',
        ...
        },
        {
            ...
            title: 'Property 3',
            html: [ '<div class="single-feature">',
                        '<thumb><img src="images/feature/6.png" alt="img"></thumb>',
                        '<div class="details">',
                            '<a href="#" class="feature-logo"><img src="images/icons/l3.png" alt="icons"></a>',
                            '<p class="author"><i class="fa fa-user"></i> Vilma Jarvi By Redbrox</p>',
                            '<h6 class="title"><a href="properties-details.html">Jason Landville Apartment</a></h6>',
        ...
        },
        {
            ...
            title: 'Property 4',
            html: [ '<div class="single-feature">',
                        '<thumb><img src="images/feature/7.png" alt="img"></thumb>',
                        '<div class="details">',
                            '<a href="#" class="feature-logo"><img src="images/icons/l3.png" alt="icons"></a>',
                            '<p class="author"><i class="fa fa-user"></i> Vilma Jarvi By Redbrox</p>',
                            '<h6 class="title"><a href="properties-details.html">Jason Landville Apartment</a></h6>',
