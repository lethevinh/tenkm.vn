...
window.admin.dialogAfterSave = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
...
$('.btn-nestable-save').click(function () {
  var selector = $(this).data('nestable-selector');
  var treeSelected = $('#' + selector);
  var data = treeSelected.nestable('serialize');
  ...
  if (data.length > 0) {
    ...
    if (section.children.length > 0) {
      Dcat.loading();
      section.children.map( /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(lecture, index) {
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return $.post('/admin/lectures/' + lecture.id, {
                    order_nb: index,
                    '_token': Dcat.token,
                    '_method': 'PUT'
                  });
                ...
                case 2:
                  ...
                  Dcat.loading(false);
                  _context2.next = 6;
                  return window.admin.dialogAfterSave();
...
/***/ "./resources/sass/admin/skin-vi-admin.scss":
/*!*************************************************!*\
  !*** ./resources/sass/admin/skin-vi-admin.scss ***!
  \*************************************************/
/*! no static exports found */
